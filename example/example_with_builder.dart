...
part 'example_with_builder.g.dart';

// Define a class Counter using `GenModule`, and extending the generated class.
@GenModule()
class Counter extends _$Counter {
  // Declare an output accessor, which the generator will populate.
  @Output()
  late final Logic val;

  // Annotate inputs with `@Input()` and expose a configurable value width.
  Counter(@Input() super.en, @Input() super.reset, @Input() super.clk,
      {super.valWidth = 8}) {
